                    ...
                    <div className="flex gap-6 mb-6">
                        ...
                        <div className="flex-1">
                            ...
                            {selectedBook.author_name && (
                                <p className="text-gray-600 mb-4">by {selectedBook.author_name.join(", ")}</p>
                            )}
                    ...
                    <div className="border-t pt-4">
                        ...
                        {bookUsers.length > 0 ? (
                            <div className="space-y-2">
                                {bookUsers.map(user => (
                                    <div key={user.userFid} className="flex items-center gap-2">
                            ...
                            <p className="text-gray-500">No other users have logged this book yet.</p>
                        )}
                    </div>
                </div>
            </div>
                ...
                <div className="p-4 border-b border-black bg-gray-50">
                    ...
                    <div className="space-y-3">
                        {searchResults.map((book, idx) => (
                            <div key={idx} className="flex gap-3 bg-white p-3 rounded border border-gray-200">
                                {book.cover_i && (
                                    <img
